...
<div class="box inverse">
    ...
    <form action="<?=base_url(); ?>Asusers/Modifyadd/<?= $recs['id'] ?>" method="post" enctype="multipart/form-data" >
...
<span class="input-group-addon"><i class="ace-icon fa fa-user"></i></span>
        ...
        <span class="errname"><?php echo form_error('username'); ?></span>
                         </div></div></div>
                </th> <th></th></tr>
             <tr>  <th></th> <th>
                <div class="form-group">
...
<span class="input-group-addon"><i class="ace-icon fa fa-user"></i></span>
  ...
  <span class="input-group-addon"><i class="ace-icon fa fa-key " aria-hidden="true"></i></span>
                ...
                <span class="errname"><?php echo form_error('password'); ?></span>
                 </div></div></div>
                </th> <th></th></tr>
                 <tr>  <th></th> <th>
                       <div class="form-group">
  ...
  <span class="input-group-addon"><i class="fa fa-envelope-o " aria-hidden="true"></i></span>
        ...
        <span class="errname"><?php echo form_error('email'); ?></span>
            </div></div></div>
                </th> <th></th></tr>
                 <tr>  <th></th> <th>
...
<div class="col-sm-2">
      ...
      <input type="checkbox" id="checkbox"  class="ace ace-switch ace-switch-6" onchange="showCD(this.value)" name="cbact" <?php if($recs['Isread']==1){?> checked <?php } ?> />
