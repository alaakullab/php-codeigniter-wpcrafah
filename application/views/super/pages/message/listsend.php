...
<div class="pull-right tableTools-container">
    <div class="dt-buttons btn-overlap btn-group">
        ...
        <a href="Messages/actionsend"  class="dt-button buttons-csv buttons-html5 btn btn-white btn-primary btn-bold" hidden   name="export" class="btn btn-success" value="Export" ><span><i class="fa fa-database bigger-110 orange"></i> <span class="hidden">Export to CSV</span></span></a>
...
<tbody align="right" >
	...
	<tr  <?php  if($row->Isread==0){ ?> style="background:#ffc573" <?php }else{ ?>
  style="background:#ffffff" <?php } ?>>
     ...
     if($row->senderfile != NULL){ ?>
            <a target="_blank" href="assets/upload/<?php echo $row->senderfile; ?>" ><span class="attachment"><i class="ace-icon fa fa-paperclip"></i>
               ...
               <?php } else{  } ?>
            <a style=" margin-right: 14px;" href="Messages/detailsmsg/<?= $row->id; ?>"><?php echo $row->title; ?></a></td>
...
<div class="hidden-sm hidden-xs action-buttons">          
  ...
  class="red"  <?php } ?>
       href="Messages/deletesed/<?php echo $row->id; ?>" onclick="return confirm('هل تريد بالتأكيد حذف هذا القسم');">
