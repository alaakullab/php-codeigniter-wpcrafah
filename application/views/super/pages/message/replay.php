...
<div  class="col-md-10">
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-heading ui-draggable-handle">
                                    <h3 class="panel-title">نموذج الرد الرسائل</h3>
                                </div>
...
<option value="<?php echo $recmsg['senderid']; ?>" <?php if($recmsg['senderid'] != $recmsg['id']){ ?> Selected <?php } ?>><?php echo $recmsg['sendername']; ?></option>
...
<div class="input-icon block col-xs-12 no-padding">
	...
	<tr>
        ...
        <button type="submit" class=" btn btn-success btn-rect" name="btnSend">إرسال  رد</button>
