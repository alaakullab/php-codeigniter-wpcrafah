...
<?php
    echo form_open('Home/Initiativeslist');
 ...
 <div class='panel-heading ui-draggable-handle dark'>
  ...
  <div class=' col-lg-4'>
    ...
    <div class="dt-buttons btn-overlap btn-group">
     ...
     <a href="Initiatives/action"  class="dt-button buttons-csv buttons-html5 btn btn-white btn-primary btn-bold" hidden   name="export" class="btn btn-success" value="Export" ><span><i class="fa fa-database bigger-110 orange"></i> <span class="hidden">Export to CSV</span></span></a>
