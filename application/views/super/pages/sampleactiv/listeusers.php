...
<?php
    echo form_open('Home/sampleactivlistusers');
 ...
 <div class='panel-heading ui-draggable-handle dark'>
  ...
  <div class=' col-lg-4'>
    ...
    <div class="dt-buttons btn-overlap btn-group">
        ...
        <a  href='Sampleactiv/addsampleadd' class="dt-button buttons-copy buttons-html5 btn btn-white btn-primary btn-bold"  aria-controls="dynamic-table" data-original-title="" title=""><span><i class="fa fa-plus-circle purple bigger-110 pink"></i> <span class="hidden">Copy to clipboard</span></span></a>
