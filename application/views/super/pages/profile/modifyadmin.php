...
<div class="box inverse">
    ...
    <form action="<?=base_url(); ?>Myprofile/Modifyadmin/<?= $recs['id'] ?>" method="post" enctype="multipart/form-data" >
        ...
        if($recs['imgsrc']==""){ ?>
          <img  src="assets/image/users/user.png" width="100" height="100">
          <?php }else{
            ?>  <div class="col-lg-8">
          <img src="assets/image/users/<?php echo $recs['imgsrc']; ?>" width="100" height="100"
               ></div>
      <?php  } ?>
            </div> 
            <div calss="form-group file-input-container">
              <div class="form-group" id="form-attachments">
                  
        <label  for="text1" class="control-label col-lg-3"></label>
         <div class="col-sm-8"><label class="ace-file-input width-90 inline">  <input type="file" name="fleImage" size="25" class="well well-sm"><span class="ace-file-container" data-title="إستعراض"><span class="ace-file-name" data-title="إضعط لإختيار صورة"><i class=" ace-icon fa fa-upload"></i></span></span><a class="remove" href="#"><i class=" ace-icon fa fa-times"></i></a></label>
...
<span class="input-group-addon"><i class="ace-icon fa fa-user"></i></span>
                <input type="text" name="username" value="<?php  echo $recs['username']; ?>"  data-class=".live-name"  class="form-control live" required="required" placeholder="" >
        ...
        <label  for="text1" class="control-label col-lg-3">الكنية :</label>
                     <div class="col-lg-8">
                          <div class="input-group">
<span class="input-group-addon"><i class="ace-icon fa fa-user"></i></span>
                <input type="text" name="nicknames" value="<?php  echo $recs['nickname']; ?>"  data-class=".live-nickname"  class="form-control live" required="required" placeholder="" >
                         </div> </div></div>
                </th> <th></th></tr>
        <?php } ?>
                 <tr>  <th></th> <th>
